...
class TLOPOTrackerApp:
    ...
    def _open_settings(self):
        ...
        Label(parent, text=f"Type a number ({MIN_CLOSE_COOLDOWN_MS}-{MAX_CLOSE_COOLDOWN_MS}). After a\n"
                            ...
                            "out animation as a new chest. Lower this if you're running "
                            "multiple\ncharacters and swapping between windows quickly and a chest\n"
                            "sometimes doesn't get picked up right after another one closed.",
              bg=BG, fg=GREY, justify=LEFT, font=("Segoe UI", 8)).pack(anchor=W, padx=10)
