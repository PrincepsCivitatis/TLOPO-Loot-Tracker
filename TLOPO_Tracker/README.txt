...
This works per-window on this multi-character branch, same as loot
detection - each simultaneously-open TLOPO window tracks its own boss
encounter and kill count independently.
